...
@section('content')
  ...
  <form class="mt-2" action='{{url("anggota")}}' method="post">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">SMP KEMALA BHAYANGKARI 9 WARU</label>
                    ...
                    <div class="row">
                       <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="id" value="{{ $itemanggota->id }}" readonly='true'>
                        </div>
                       </div>
                       <div class="col-md-2">
                        <div class="form-group">
                          <label class="bmd-label-floating">No Induk</label>
                          <input type="text" class="form-control" name="nomor_induk" value="{{$itemanggota->no_induk}}"  readonly="true">
                        </div>
                      </div>
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="kelas" value="{{$itemanggota->kelas}}"  readonly="true">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nama" value="{{$itemanggota->nama}}"  readonly="true">
                        </div>
                      </div>
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Email </label>
                          <input type="email" class="form-control" name="email" value="{{$itemanggota->email}}"  readonly="true">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="alamat" value="{{$itemanggota->alamat}}"  readonly="true">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="jenis_kelamin" value="{{$itemanggota->jenis_kelamin}}"  readonly="true">

                      <!--                           
                           <select name="jenis_kelamin"  readonly="true"> 
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="telepon" value="{{$itemanggota->telepon}}"  readonly="true">
                        </div>
                      </div>
                    </div>
                    <a href="{{url('anggota/')}}"><span class="material-icons">keyboard_backspace</span> Kembali</a> 
