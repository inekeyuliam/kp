              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form>
                    ...
                    <div class="row">
                       <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="kode_anggota" id="kode_anggota" value="{{ $kode }}" readonly='true'>
                        </div>
                       </div>
                       <div class="col-md-2">
                        <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="tanggal" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->toDateString())) }}" readonly="true">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <a href="{{url('anggota/')}}" class="btn btn-primary pull-right">Batal</a>  -->
