          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                <form action="/buku/search"class="navbar-form">
                <div class="input-group no-border">
                  <input type="text" value="" class="form-control" placeholder="Cari Berdasarkan Judul atau Kode Buku..." name="search">
                ...
                <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {{$item->kategori_buku->nama_kategori}}
                          </td>
                          <td>
                             {{$item->penulis_buku->nama_penulis}}
                          </td>
                          <td >
                             {{$item->penerbit_buku->nama_penerbit}}
                          </td>
                          <td >
                             {{$item->ISBN}}
                          </td>
                          ...
                          <td >
                           ...
                           <td>
                           <a href="{{url('buku/'.$item->id.'/edit')}}"><span class="material-icons">edit</span></a>
                          </td> 
                          <td >
                          <form method="POST" action="{{ url('buku/'.$item->id) }}" id="form-hapus-{{ $item->id }}">
                            {{ method_field("DELETE") }}
                   ...
                   <a href="{{url('buku/create')}}" class="btn btn-primary btn-round">Tambah</a>
                </div>
              </div>
            </div>
