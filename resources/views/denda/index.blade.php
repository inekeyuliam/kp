            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Daftar Denda Buku</h4>
                </div>
                <div class="card-body">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <td>
                          ...
                          <td>
                          <a href="{{url('denda/'.$item->id.'/edit')}}"><span class="material-icons">edit</span></a>
                          </td> 
                          <td >
                             <form method="POST" action="{{ url('denda/'.$item->id) }}" id="form-hapus-{{ $item->id }}">
                            {{ method_field("DELETE") }}
                       ...
                       @endforeach
                        ...
                        <a href="{{url('denda/create')}}" class="btn btn-primary btn-round">Tambah</a>
                </div>
              </div>
            </div>
