                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        @foreach($listpenerbit as $key=>$item)
                        <tr>
                          ...
                          <td>
                          <a href="{{url('penerbit/'.$item->id.'/edit')}}"><span class="material-icons">edit</span></a>
                          </td> 
                          <td >
                             <form method="POST" action="{{ url('penerbit/'.$item->id) }}" id="form-hapus-{{ $item->id }}">
                            {{ method_field("DELETE") }}
                       ...
                       @endforeach
                        ...
                        <a href="{{url('penerbit/create')}}" class="btn btn-primary btn-round">Tambah</a>
                </div>
              </div>
            </div>
