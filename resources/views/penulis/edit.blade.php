...
@section('content')
  ...
  <form class="mt-2" action='{{url("penulis/".$itempenulis->id)}}' method="post">
     {{ method_field("PUT")}}
                ...
                <div class="card-body">
                  <form>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Nama Penulis</label>
                          <input type="text" class="form-control" name="nama_penulis" value="{{$itempenulis->nama_penulis}}">
                        </div>
                      </div>
                    </div>
