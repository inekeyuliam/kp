...
@section('content')
  ...
  <form class="mt-2" action='{{url("pinjam/".$detilpinjam->id)}}' method="post">
    {{ method_field("PUT")}}
            ...
            <div class="col-md-10">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Edit Status Peminjaman Buku</h4>
                </div>
                <div class="card-body">
                  <form>
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <input type="date" readonly="true" class="form-control" name="tgl_pinjam" value="{{ $detilpinjam->tgl_pinjam }}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                       <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="kode_transaksi" id="kode_transaksi" value="{{ $detilpinjam->kode_transaksi }}" readonly='true'>
                        </div>
                       </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="anggota_id" id="anggota_id" readonly="true" value="{{ $detilpinjam->anggota_id }}" >
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">ID Buku </label>
                          <input type="text" class="form-control" name="idbuku" id="idbuku" readonly="true" value="{{ $detilpinjam->buku_id }}">
                        </div>
                    </div>  
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <input type="date" readonly="true" class="form-control" name="tgl_batas" value="{{ $detilpinjam->tgl_batas }}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <input type="date" readonly="true" class="form-control" name="tgl_kembali" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->toDateString()))  }}">
                        </div>
                      </div>
                    </div>
                  <div class="row">
                   <div class="col-md-2">
                     ...
                     <label class="bmd-label-floating">Status</label>
                       <select class="form-control" name="status">
                          ...
                          <option value="pinjam" @if($detilpinjam->status == 'pinjam') selected ='selected' @endif>Pinjam</option>
                          <option value="kembali" readonly='true' @if($detilpinjam->status == 'kembali') selected ='selected' @endif>Kembali</option>
                      </select>
                     </div>
                   </div>
                  </div>
