...
@section('content')
  ...
  <form class="mt-2" action='{{url("kategori/".$itemkat->id)}}' method="post">
     {{ method_field("PUT")}}
                    ...
                    <div class="row">
                       <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="kode_kategori" id="kode_kategori" value="{{$itemkat->kode_kategori}}" readonly='true'>
                        </div>
                       </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nama_kategori" value="{{$itemkat->nama_kategori}}">
                        </div>
                      </div>
                    </div>
