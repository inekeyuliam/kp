...
@section('content')
  ...
  <form class="mt-2" action='{{url("kategori")}}' method="post">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form>
                    ...
                    <div class="row">
                       <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="kode_kategori" value="{{ $kode }}" readonly='true'>
                        </div>
                       </div>
                    </div>
                    <div class="row">
                    ...
                    <a href="{{url('kategori/')}}" class="btn btn-primary pull-right">Batal</a>  -->

                    <button type="submit" class="btn btn-primary btn-round pull-right"><i class="material-icons">check</i> Simpan</button>
                    <a href="{{url('kategori/')}}" class ="btn btn-primary btn-round"> <i class="material-icons">cancel</i> Cancel</a>
