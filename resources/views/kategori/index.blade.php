                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        @foreach($listkategori as $key=>$item)
                        <tr>
                          ...
                          <td>
                          <a href="{{url('kategori/'.$item->id.'/edit')}}"><span class="material-icons">edit</span></a>
                          </td> 
                          <td >
                             <form method="POST" action="{{ url('kategori/'.$item->id) }}" id="form-hapus-{{ $item->id }}">
                            {{ method_field("DELETE") }}
                       ...
                       @endforeach
                        ...
                        <a href="{{url('kategori/create')}}" class="btn btn-primary btn-round">Tambah</a>
                </div>
              </div>
            </div>
